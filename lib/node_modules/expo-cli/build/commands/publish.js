...
async function action(projectDir, options = {}) {
  ...
  const target = (_options$target = options.target) !== null && _options$target !== void 0 ? _options$target : (0, _config().getDefaultTarget)(projectDir); // note: this validates the exp.owner when the user is a robot
  ...
  if (user.kind === 'robot') {
    (0, _log().default)(`- Owner: ${_log().default.chalk.bold(owner)}`);
  }
